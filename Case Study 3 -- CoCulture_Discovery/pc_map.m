function [pce,elapsedtime] = pc_map(X,Y,Ns,Np)
clc;
...
inputOpts.Marginals(4).Parameters= [x4m x4s];

inputOpts.Marginals(5).Type = 'Gaussian';
inputOpts.Marginals(5).Parameters= [x5m x5s];
...
CMetaOpts.Display = 1;
CMetaOpts.TruncOptions.qNorm = 0.65:0.05:0.85;
